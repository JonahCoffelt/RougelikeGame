...
fov = 15 #Number of tiles displayed on screen
        ...
        for y in range(mapSize-1):
            if map[x][y] == 1:
                if (map[x + 1][y] != 1 or map[x - 1][y] != 1 or map[x][y + 1] != 1 or map[x][y - 1] != 1 or 
                    ...
                    #image_surf = pygame.transform.scale(images[0][get_tile_state(x, y, map, 1)], (gridSize, gridSize))
